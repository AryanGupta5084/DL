...
Easy_data = np.array(Easy_data, dtype=object)
Medium_data = np.array(Medium_data, dtype=object)
Hard_data = np.array(Hard_data, dtype=object)
...
# ----------------- Train -----------------
model.fit(train_data, train_labels, batch_size = 128, epochs = 30, 
